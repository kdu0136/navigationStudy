...
class Register : BaseFragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        view.findViewById<Button>(R.id.homeBtn).setOnClickListener {
            findNavController().navigate(R.id.registerToHome, bundleOf("num" to fragNum + 1))
        }
        view.findViewById<Button>(R.id.leaderBoardBtn).setOnClickListener {
            findNavController().navigate(R.id.registerToLeader, bundleOf("num" to fragNum + 1))
        }
        view.findViewById<Button>(R.id.registerBtn).setOnClickListener {
            findNavController().navigate(R.id.registerToRegister, bundleOf("num" to fragNum + 1))
        }
        view.findViewById<Button>(R.id.registeredBtn).setOnClickListener {
            findNavController().navigate(R.id.registerToRegistered, bundleOf("num" to fragNum + 1))
        }
